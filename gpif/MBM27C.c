...
// IF/Wait  Wait 14   Wait 1    IF        Wait 1    Wait 1    Wait 1    Wait 1             
//   Term A                     IntReady                                                   
//   LFunc                      AND                                                        
//   Term B                     IntReady                                                   
// Branch1                      ThenIdle                                                   
...
// NextData SameData  SameData  SameData  SameData  SameData  SameData  SameData           
// Int Trig No Int    No Int    No Int    No Int    No Int    No Int    No Int             
// IF/Wait  Wait 100  IF        Wait 100  IF        Wait 1    Wait 1    Wait 1             
//   Term A           IntReady            IntReady                                         
//   LFunc            AND                 AND                                              
//   Term B           IntReady            IntReady                                         
...
// NextData SameData  SameData  SameData  SameData  SameData  SameData  SameData           
// Int Trig No Int    No Int    No Int    No Int    No Int    No Int    No Int             
// IF/Wait  Wait 11   Wait 1    Wait 2    IF        Wait 1    Wait 1    Wait 1             
//   Term A                               IntReady                                         
//   LFunc                                AND                                              
//   Term B                               IntReady                                         
// Branch1                                ThenIdle                                         
